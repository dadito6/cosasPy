...
root = Tk()
root.title("CONVERTIDOR DE TIEMPO REAL")
#ventana
...
def convert(c1, c2, amount):
    try:
        ...
        messagebox.showerror("Error", "Algo fallo , intente mas tarde.. Sorry!")
...
def help():
    ...
    newbutton = Button(newframe, text="Back", font=("Comic Sans MS", 11, "bold"), bg="pink", fg="black",
                       activeforeground="pink", activebackground="black", command=lambda: newwin.destroy())
...
background_image = ImageTk.PhotoImage(Image.open("C:\\Users\\Cesar\\Pictures\\Saved Pictures\\messi (2).jpg"))
...
label1 = Label(frame, text = "FROM", font =FONT, bd =5, bg ="#FFEBCD", highlightbackground = "#d9138a", fg = "black")
label1.place(relx = 0.15, rely = 0.02,relwidth = 0.15, relheight =0.25)

label2 = Label(frame, text = "TO", font =FONT, bd =5, bg ="#FFEBCD", highlightbackground = "#d9138a", fg = "black")
...
listbox1.config(bg = "#FAFAD2", fg = "black", activeforeground = "#fc034e", activebackground = "black", font=FONT)
listbox1.place(relx = 0.07,rely = 0.3, relheight = 0.28, relwidth = 0.38)

clicked2 = StringVar()
clicked2.set("Select")
listbox2 = OptionMenu(frame,clicked2, *options)
listbox2.config(bg = "#FAFAD2", fg = "black", activeforeground = "#fc034e", activebackground = "black", font=FONT)
listbox2.place(relx = 0.56,rely = 0.3, relheight = 0.28, relwidth = 0.38)

#amount
label3 = Label(frame, text = "MONTO", font = FONT, bg = "#FFEBCD", highlightbackground = "#12a4d9", fg = "black")
...
#buttons
button1 = Button(root, text = "CONVERTIR", font = FONT, bg = "green", fg = "white", activeforeground = "pink", activebackground = "black", command = lambda:convert(clicked1.get(), clicked2.get(), entry.get()))
button1.place(relx = 0.16,rely = 0.4,relwidth = 0.15, relheight = 0.07)

button2 = Button(root, text = "CLEAR", font = FONT,  bg = "red", fg = "black", activeforeground = "pink", activebackground = "black", command=clear)
